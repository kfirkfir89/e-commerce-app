    ...
    <div className="flex  w-full flex-col items-center">
      ...
      {!isLoading && previewData !== undefined ? (
        <>
            ...
            <div className="container flex h-full w-full flex-col items-center sm:p-6">
              <div className="relative hidden w-full max-w-7xl items-center justify-center p-2 sm:flex">
                <div className="absolute  h-full w-full">
                  <div className="absolute z-10 h-full w-2 bg-green-500" />
                  <div className="absolute right-0 z-10 h-full w-2 bg-purple-500" />
                ...
                <div className="absolute z-50 h-full w-full">
                  <div className="relative flex h-full w-full justify-center">
                    <NavLink
                      ...
                      className=" btn-outline btn absolute bottom-28  flex rounded-none border-dashed px-32 py-6 text-slate-700  opacity-70 shadow-sm hover:opacity-90"
                    >
          ...
          {/* small banner images */}
          <div className=" container grid h-full w-full max-w-7xl grid-cols-2 gap-8 p-2 pt-8 sm:grid-cols-4 sm:p-6">
